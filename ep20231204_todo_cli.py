...
def table_header():  # шапка таблицы, что бы не окарать, когда меняешь пареметры 
    ...
    # todo_table._max_width = {"Дата создания" : 20}
    # todo_table._min_width = {"Дата создания" : 20}
    todo_table._max_width = {"Исполнение до" : 20}
    todo_table._min_width = {"Исполнение до" : 20}
