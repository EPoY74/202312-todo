"""
Модуль для работы с БД SQLite для проекта todo_cli
Raises:
...
def work_with_data(
    ...
    type_of_sql - тип SQL ,запись или чтение (read, write), если нужно
     закомитить в БД,то выбирать write
...
# Это одна из немногих, переменных, которые будут глобальными.
# Мог бы сделать без нее, считывая
# каждый раз имя БД с конфигурации, но, что бы избежать подмены
# - решил сделать одну переменную глобальной
